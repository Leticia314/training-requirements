...
According to our analysis treatment with estrogen is mostly affecting processes related to the cell cycle in osteoblasts. As the authors of the paper mention, estrogen can act rapidly to regulate signal transduction through pathways such as ERK and PI3K, and these pathways can control the induction and activation of cell cycle events (Chambard et al., 2007; Chang et al., 2003). 
